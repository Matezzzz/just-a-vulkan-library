...
{}
FramebufferInfo::FramebufferInfo(glm::uvec2 size, const vector<VkImageView>& images, VkRenderPass render_pass, VkFramebufferCreateFlags create_flags) :
    FramebufferInfo(size.x, size.y, images, render_pass, create_flags)
{}
