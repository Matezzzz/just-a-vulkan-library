...
/**
 * vulkan_function_list.inl
 *  - List of all vulkan functions to be used
 *  - This is included multiple times by vulkan_base.h and vulkan_base.cpp
 *    - vulkan_base.h - define all function pointers as extern
 *    - vulkan_base.cpp - define all functions, then initialize them when loading global/instance/device
 */
...
INSTANCE_LEVEL_VULKAN_FUNCTION_FROM_EXTENSION( vkDestroySurfaceKHR, VK_KHR_WIN32_SURFACE_EXTENSION_NAME)
