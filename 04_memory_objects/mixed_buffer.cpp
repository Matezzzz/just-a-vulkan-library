...
UniformBufferRawData::UniformBufferRawData(uint32_t size) : UniformBufferData(size)
{}
...
UniformBufferRawDataSTD140::UniformBufferRawDataSTD140(uint32_t size) : UniformBufferRawData(size)
{}
